from classes.dbactions import DBActions
...
def verify_postback_url(action):
    get_collect_user_info_code = get_collect_user_info(270109)
    matched_postback_types = find_post_backs_received(270109, 1534615290)
    ...
    if action == "SignUp":
        ...
        matched_postback_ids = find_post_backs_ids(270109, 1534615290)
        for id in matched_postback_ids:
            ...
            if not parse_post_back_url(current_config_URL):
                ...
                notif_param_map = parse_post_back_url(db_agent.get_url_from_notif(id, 1534615290))
                ...
                if postback_type == 5:
                    expected_payment_account_id = db_agent.get_payment_acct_id(1534615290)
